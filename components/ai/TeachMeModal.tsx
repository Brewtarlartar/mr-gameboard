    ...
    <>
      <div className="flex items-center justify-between px-3 py-2 sm:px-4 sm:py-3 border-b border-stone-800 bg-stone-900/95 backdrop-blur">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <div>
                    <h2 className="text-stone-100 font-semibold text-sm sm:text-base">Skip the Rulebooks</h2>
                    <p className="text-[10px] sm:text-xs text-stone-400">
                      {plan ? plan.title : 'Get a guided teach for your table'}
                    </p>
                  </div>
                </div>
                <button
              ...
              {plan && chapter && (
                <>
                  <div className="px-4 py-2 border-b border-stone-800 flex items-center justify-between bg-stone-900/70">
                  ...
                  <div className="flex-1 overflow-y-auto px-3 py-3 sm:px-4 sm:py-4">
                    <h3 className="text-lg sm:text-xl font-bold text-stone-100 mb-2">{chapter.heading}</h3>
                    <MarkdownMessage>{chapter.body}</MarkdownMessage>
                  </div>

                  <div className="border-t border-stone-800 bg-stone-900 px-3 py-3 space-y-2">
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 text-sm text-stone-300 hover:text-stone-100 border border-stone-700 hover:border-stone-600 rounded-xl flex items-center justify-center gap-2 transition-colors"
                    >
  ...
  const wrapper = inline ? (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="max-h-[calc(100dvh-10rem)] sm:max-h-[80vh] rounded-2xl bg-stone-900 border border-stone-700 flex flex-col overflow-hidden shadow-xl shadow-amber-900/10">
            {body}
          </div>
        </motion.div>
      )}
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full sm:max-w-2xl h-[92vh] sm:h-[85vh] sm:rounded-2xl bg-stone-900 border-t sm:border border-stone-700 flex flex-col overflow-hidden"
